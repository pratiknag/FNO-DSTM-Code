...
def main():
    ...
    merged_df1 = merged_df1.dropna(subset=["Station_Value"])
    ...
    final_df1 = merged_df1[["yymmdd", "LATITUDE", "LONGITUDE", "STATION_NUMBER", "Station_Value"]]
    print("preprocessed dataset -------------")
    print(final_df.head())

    # Save the result
    final_df.to_csv("datasets/dataset-10DAvg.csv", index=False)
    final_df1.to_csv("datasets/dataset-10DAvg-nonnormalized.csv", index=False)
