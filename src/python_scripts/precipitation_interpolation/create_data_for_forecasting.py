...
def main():
    ...
    output_file = 'datasets/precipitation_interpolated_data-sample.npy'
    np.save(output_file, median_array)
    
    output_file = 'datasets/ub_data-interpolation.npy'
    np.save(output_file, ub_array)
    
    output_file = 'datasets/lb_data-interpolation.npy'
